...
public class FinancialApplicationPrintATaxTable {
    /** Main method */
    public static void main(String[] args) {
        ...
        for (int i = 50000; i <= 60000; i = i + 50) {
            double j = i;
            System.out.printf("%d%11d%11d%18d%11d\n",i ,
                    Math.round(computeTax(0,j)), Math.round(computeTax(1, j)),
                    Math.round(computeTax(2, j)), Math.round(computeTax(3, j)));
        }
    }

    /** The method from computing tax */
    public static double computeTax(int status, double taxableIncome) {
        ...
        if (status == 0){ // Compute tax for single filers
        ...
        else if (status == 1){ // Compute tax from married file jointly or qualifying widow(er)
            if (taxableIncome <= 16700)
                tax = taxableIncome * 0.10;
            else if (taxableIncome <= 67900)
                tax = 16700 * 0.10 + (taxableIncome - 16700) * 0.15;
            else if (taxableIncome <= 173050)
        ...
        else if (status == 2){ // Compute tax from married separately
            if (taxableIncome <= 8350)
                tax = taxableIncome * 0.10;
            else if (taxableIncome <= 33950)
                tax = 8350 * 0.10 + (taxableIncome - 8350) * 0.15;
            ...
            if (taxableIncome <= 11950)
                ...
                tax = 11950 * 0.10 + (45500 - 11950) * 0.15 +
                        (117450 - 45500) * 0.25 + (190200 - 117450) * 0.28 +
                        (372950 - 190200) * 0.33 + (taxableIncome - 372950);
        }
