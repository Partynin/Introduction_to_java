...
//        System.out.println("t1.contains(3, 3) = " + t1.contains(3, 3) + "\nr1.contains(new Triangle2D(new" +
//                "MyPoint(2.9, 2), new MyPoint(4, 1),new MyPoint(1, 3.4))) is " + t1.contains(new Triangle2D(new
...
//                "-3),new MyPoint(2, 6.5))) is " + t1.overlaps(new Triangle2D(new MyPoint(2, 5.5),
