...
public class WebCrawler_Exe21_14 {
    public static void main(String[] args) {
        Scanner input = new Scanner(System.in);
        System.out.print("Enter a URL: ");
        String url = input.nextLine();
        crawler(url); // Travers the Web from the a starting url
    }
    ...
    public static void crawler(String startingURL) {
        ...
        listOfPendingURLs.addFirst(startingURL);
    ...
    public static LinkedList<String> getSubURLs(String urlString) {
            ...
            while (input.hasNext()) {
                ...
                while (current > 0) {
                    ...
                    if (endIndex > 0) { // Ensure that a correct URL is found
                        list.addFirst(line.substring(current, endIndex));
