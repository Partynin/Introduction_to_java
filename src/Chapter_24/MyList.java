...
public interface MyList<E> extends Iterable<E>{
     ...
     * Shift an subsequent elements to the left.
     ...
     * Return true if this list changed as a result of hte call.
     */
    public boolean removeAll(MyList<E> otherList);

    /** Retains the element in this list that are also in otherList
     * Returns true if this list changed as a result of the call.
     */
